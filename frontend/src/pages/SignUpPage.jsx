						...
						<div>
							...
							<div className='mt-1 relative rounded-md shadow-sm'>
								...
								<input
									...
									className='block w-full px-3 py-2 pl-10 bg-gray-800 border border-gray-600 rounded-md shadow-sm
						...
						<div>
							...
							<div className='mt-1 relative rounded-md shadow-sm'>
								...
								<input
									...
									rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-purple-500 
